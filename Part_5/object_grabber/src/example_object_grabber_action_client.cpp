...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.x = 0.513532;
    object_poseStamped.pose.position.y = 0.013735;
    object_poseStamped.pose.position.z = -0.05; //-0.125; //pose w/rt world frame
    object_poseStamped.pose.orientation.x = 0.016101;
    object_poseStamped.pose.orientation.y = 0.007777;
    ...
    object_dropoff_poseStamped.pose.position.x = 0.513532;
    object_dropoff_poseStamped.pose.position.y = 0.013735;
    object_dropoff_poseStamped.pose.position.z = 0.3; //-0.125; //pose w/rt world frame
}
